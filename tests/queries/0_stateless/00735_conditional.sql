...
SELECT materialize(toDate('2001-01-01')) AS x, toDateTime('2000-01-01 00:00:01') AS y, ((x > y) ? x : y) AS z, toTypeName(x), toTypeName(y), toTypeName(z);
...
SELECT materialize(toDateTime('2000-01-01 00:00:00') AS x, toDate('2000-01-01') AS y, ((x > y) ? x : y) AS z, toTypeName(x), toTypeName(y), toTypeName(z);
