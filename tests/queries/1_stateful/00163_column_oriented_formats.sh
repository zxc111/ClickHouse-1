...
do
    ...
    $CLICKHOUSE_CLIENT -q "CREATE TABLE 00163_column_oriented(ClientEventTime DateTime('UTC'), MobilePhoneModel String, ClientIP6 FixedString(16)) ENGINE=File($format)"
